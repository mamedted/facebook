    ...
    <>
      <div className="flex between border-b border-gray-200 -mx-[14px] px-[14px] py8">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24" role="img" aria-label="Market">
          <path fill="none" stroke="currentColor" stroke-width="2" d="M3 9l2-5h14l2 5" />
          <path fill="none" stroke="currentColor" stroke-width="2" d="M3 9h18v2c0 1.1-.9 2-2 2s-2-.9-2-2c0 1.1-.9 2-2 2s-2-.9-2-2c0 1.1-.9 2-2 2s-2-.9-2-2c0 1.1-.9 2-2 2s-2-.9-2-2V9z" />
          <rect x="5" y="13" width="14" height="8" fill="none" stroke="currentColor" stroke-width="2" />
          <rect x="10" y="15" width="4" height="6" fill="none" stroke="currentColor" stroke-width="2" />
        </svg>
      </div>
    </>
  );
